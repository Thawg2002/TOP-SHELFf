import { ImgProduct } from "@/assets/img";

type Props = {};

const BestProductDispensary = (props: Props) => {
    return (
        <>
            {/*best dispensary*/}
            <div
...
mb:gap-x-[16px] *:mb:h-[40px] *:sm:h-[48px] *:lg:text-base *:mb:text-sm *:rounded-[100px] *:bg-[#F2F6F4"
  ...
  lg:w-[1348px] rounded-xl lg:translate-x-[28px]"
      ...
      items-center justify-center gap-y-6"
                    ...
                    {/* products mobile */}
                    <div className="sm:hidden w-full custome_scroll_x_center_item snap-x mt-8 h-full overflow-x-auto hidden_scroll_x">
                        <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-6 ">
                            {/* item 1 */}
...
export default BestProductDispensary;
