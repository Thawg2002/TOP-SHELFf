            ...
            <div className="relative lg:pt-[403px] mb:pt-[271px] lg:w-[1200px] mb:w-[342px] mx-auto">
                ...
                <div className="flex lg:flex-row mb:flex-col lg:gap-x-16 lg:gap-y-0 gap-y-8 *:w-full">
                    <div className="lg:w-[385px]">
                        <img className="w-[173px] h-[42px]" src={logo} alt="" />
                        <p className="text-[#9D9EA2] mt-6 font-normal lg:w-full w-[276px]">
                            #1 Canadian top rated online dispensary that meets
                            the customers needs in every single medical
                            marijuana aspect. The team here at TopShelfBC is
                            heavily involved in the Canadian cannabis industry
                            for over 15 years. We strive to provide the top
                            quality products, service and care at the lowest
